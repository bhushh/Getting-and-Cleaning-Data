#Assignment submisson for the course 'Getting and Cleaning Data' on Coursera
...
#We create tidyData as a data set with average for each activity and subject. Then, we order the enties in tidyData and write it into data file FinalData.txt that contains the processed data.
